    ...
    if (summaryEl) {
        summaryEl.innerHTML = `
            <div class="summary-card total">
                Total<br><span style="font-size:1.4rem;">${lapakData.length}</span>
            </div>
            <div class="summary-card hadir">
                ✅ Hadir<br><span style="font-size:1.4rem;">${totalHadir}</span>
            </div>
            <div class="summary-card belum">
                ❌ Belum<br><span style="font-size:1.4rem;">${totalBelum}</span>
            </div>
        `;
    }
}
